...
<!-- 轮播图 end -->
	...
	<ul class="interface clear">
		<li>
			<a href="<?php echo Url('Category/manage',array('cat_id'=>$cat_id)); ?>">
				<img src="/assets/image/zhuanshu.png"/>
				<p>我的专属</p>
			</a>
		</li>
		<li>
			<a href="<?php echo Url('Category/matter',array('cat_id'=>$cat_id)); ?>">
                <img src="/assets/image/zhuanshu.png"/>
				<p>行情查询</p>
			</a>
		</li>
		<li>
			<a href="<?php echo Url('Goods/goods_list',array('cat_id'=>$cat_id)); ?>">
                <img src="/assets/image/zhuanshu.png"/>
				<p>产品上架</p>
			</a>
		</li>
