<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"E:\WWW\foo\public/../application/../template/pc/category\index_4.html";i:1508397269;s:64:"E:\WWW\foo\public/../application/../template/pc/public\head.html";i:1508157721;s:66:"E:\WWW\foo\public/../application/../template/pc/public\header.html";i:1507862389;s:64:"E:\WWW\foo\public/../application/../template/pc/public\foot.html";i:1507516574;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<!-- 轮播图 end -->
	...
	<ul class="interface clear">
		<li>
			<a href="<?php echo Url('Transport/my_car',array('model_id'=>$model_id)); ?>">
				<img src="/assets/image/zhuanshu.png"/>
				<p>我的运输</p>
			</a>
		</li>
		<li>
			<a href="<?php echo Url('Category/matter',array('model_id'=>$model_id)); ?>">
                <img src="/assets/image/zhuanshu.png"/>
				<p>行情查询</p>
			</a>
		</li>
<!--		<li>
			<a href="<?php echo Url('Transport/car_manage',array('model_id'=>$model_id)); ?>">
                <img src="/assets/image/zhuanshu.png"/>
				<p>车辆管理</p>
			</a>
		</li>-->
		<li>
			<a href="<?php echo Url('Category/near',array('model_id'=>$model_id)); ?>">
                <img src="/assets/image/zhuanshu.png"/>
				<p>附近会员</p>
			</a>
		</li>
